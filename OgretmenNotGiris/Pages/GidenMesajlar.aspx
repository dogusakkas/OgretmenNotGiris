<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Ogretmen.Master" AutoEventWireup="true" CodeBehind="GidenMesajlar.aspx.cs" Inherits="OgretmenNotGiris.Pages.GidenMesajlar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <table class="table table-bordered table-striped table-hover">
        ...
        <tbody>
            ...
            <asp:Repeater ID="Repeater_Giden_Mesajlar" runat="server">
                 <ItemTemplate>
